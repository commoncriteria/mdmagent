...
OUT = output
TRANS = transforms
APP_XML=$(IN)/mdmagent.xml
TABLE=$(OUT)/mdmagent-table.html
SIMPLIFIED=$(OUT)/mdmagent-table-reqs.html
APP_HTML=$(OUT)/mdmagent.html
APP_OP_HTML=$(OUT)/mdmagent-optionsappendix.html
APP_RELEASE_HTML=$(OUT)/mdmagent-release.html
